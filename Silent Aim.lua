...
-- Library:SetWatermark("github.com/TheSplxsh")
...
fov_circle.Color = Color3.fromRGB(138, 3, 3)
    
local mouse_box = Drawing.new("Square")
mouse_box.Visible = true 
mouse_box.ZIndex = 999 
mouse_box.Color = Color3.fromRGB(138, 3, 3)
mouse_box.Thickness = 20 
mouse_box.Size = Vector2.new(20, 20)
mouse_box.Filled = true 

local PredictionAmount = 0.250
...
do
    ...
    Main:AddToggle("Visible", {Text = "Visible"}):AddColorPicker("Color", {Default = Color3.fromRGB(138, 3, 3)}):OnChanged(function()
